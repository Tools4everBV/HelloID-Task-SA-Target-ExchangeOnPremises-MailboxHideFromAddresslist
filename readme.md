...
> The **MailboxIdentity** can hold different values [See the Microsoft Docs page](https://learn.microsoft.com/en-us/powershell/module/exchange/set-mailbox?view=exchange-ps#-hiddenfromaddresslistsenabled)
...
4. Calls the `Set-Mailbox` cmdlet to hide the mailbox from the global addresses list
